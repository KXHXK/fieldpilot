...
把首个任务从 13:30–15:30 改为 14:00–16:00，点击“应用事件并重规划”。指出：
...
- locked/completed task 不能修改。

本地 2026-07-31 浏览器验收中，该场景产生 R1 → R2、5 处变化、8 段保持、成本不变。具体数字来自固定 Fixture，只用于回归演示。
